...
const MSG_CHANNEL = 'remote-inject-ext';
const PROVIDER_UUID = 'f81d4fae-7dec-11d0-a765-00a0c91e6bf6';
    ...
    send(methodOrPayload: string | { method: string; params?: unknown[]; id?: number }, callbackOrParams?: unknown) {
      if (typeof methodOrPayload === 'string') {
        const syncMethods: Record<string, () => unknown> = {
          ...
          web3_clientVersion: () => 'RemoteInject/1.0.0',
        };
...
export const PROVIDER_ICON =
  'data:image/svg+xml,' +
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><defs><linearGradient id="t" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FFB43A"/><stop offset=".4" stop-color="#FF6E1C"/><stop offset="1" stop-color="#DC3305"/></linearGradient><radialGradient id="h" cx=".34" cy=".26" r=".9"><stop offset="0" stop-color="#fff" stop-opacity=".2"/><stop offset="1" stop-color="#fff" stop-opacity="0"/></radialGradient></defs><rect width="128" height="128" rx="28" fill="url(#t)"/><rect width="128" height="128" rx="28" fill="url(#h)"/><polygon points="73,16 41,69 59,69 51,112 87,57 69,57 83,16" fill="#fff"/></svg>`,
  );
