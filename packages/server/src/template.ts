...
const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'bridge.confirmDisconnect': '再次点击确认断开',
    ...
    'bridge.session': '会话',
    'bridge.sessionHint': '请确认 DApp 端显示相同 ID',
    'bridge.reconnecting': '重新连接中...',
    'bridge.networkDisconnected': '网络连接断开，正在尝试重连',
    'bridge.connectionLost': '连接已断开',
    'bridge.manualReconnectHint': '自动重连失败，请手动重连',
    'bridge.reconnectBtn': '重新连接',
  ...
  en: {
    ...
    'bridge.confirmDisconnect': 'Tap again to confirm',
    ...
    'bridge.sessionHint': 'Verify DApp shows same ID',
    'bridge.reconnecting': 'Reconnecting...',
    'bridge.networkDisconnected': 'Network disconnected, trying to reconnect',
    'bridge.connectionLost': 'Connection lost',
    'bridge.manualReconnectHint': 'Auto-reconnect failed, please reconnect manually',
    'bridge.reconnectBtn': 'Reconnect',
